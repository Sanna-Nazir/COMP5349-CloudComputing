...
# README FOR VOCABULARY EXPLORATION OF TRAINING DATA CORPUS #
...
##STEP 14:
From the top right corner, click the upload option and upload the code file (.ipynb) attached with this readme (Question1_Part2.ipynb).
